...
const Services = () => {
    return (
        <div id='services' className='mt-16 lg:mt-32 text-center lg:text-left scroll-mt-48'>
            <h2 className='text-[#10B981] [-webkit-text-stroke:1px_black] font-bold text-3xl lg:text-5xl text-center mb-0 lg:mb-20 mx-auto'>My Services .</h2>
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-8'>
                <div className='border-2 px-2 lg:px-6 py-2 lg:py-4 rounded-md service-card hover:shadow-lg'>
                ...
                <div className='border-2 px-2 lg:px-6 py-2 lg:py-4 rounded-md service-card hover:shadow-xl'>
                    <div className='h-[210px] w-[300px] mx-auto mt-5'>
