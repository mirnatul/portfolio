...
const Banner = () => {
    ...
    return (
        <div id='home' className='text-center lg:text-left lg:mt-20 mt-6 mx-2'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 items-center'>
                ...
                {/* <div className='mx-auto pt-3 px-16 relative overflow-hidden border-b-8 border-[#10B981] w-full lg:w-[600px]'> */}
                <div className='mx-auto pt-3 px-16 relative overflow-hidden border-b-8 border-[#10B981] w-full lg:w-[600px]'>
